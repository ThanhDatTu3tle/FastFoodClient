              ...
              <form id='registerForm'>
                  <div className={cx("input-tenDanhMuc")}>
                      <FormControl sx={{ width: '100ch' }} variant="outlined">
                          <InputLabel sx={{ fontSize: '15px' }} htmlFor="outlined-adornment-tenDanhMuc">Tên danh mục</InputLabel>
                          <OutlinedInput
                              id="tenDanhMuc"
                              sx={{ fontSize: '15px' }}
                  ...
                  <div className={cx("input-hinhAnh")}>
                      <FormControl sx={{ width: '100ch' }} variant="outlined">
                          <InputLabel sx={{ fontSize: '15px' }} htmlFor="outlined-adornment-hinhAnh">Hình ảnh danh mục</InputLabel>
                          <OutlinedInput
                              id="hinhAnh"
                              sx={{ fontSize: '15px' }}
                              value={data.hinhAnh}
